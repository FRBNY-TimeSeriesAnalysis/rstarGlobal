%% MainModel1_var25: Baseline model with variance of innovation to trend set to 1/25.

%% Initial setup

clear;

filename = '../results/OutputModel1_var25.mat';  % Output filename
...
SC0tr =    ([   1      sqrt(2)       1     1*ones(1,7)    sqrt(2)*ones(1,7)  1*ones(1,7)   ]).^2/25;  % Initial conditions Q
