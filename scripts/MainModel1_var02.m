%% MainModel1_var02: Baseline model with variance of innovation to trend set to 1/2.

%% Initial setup

clear;

filename = '../results/OutputModel1_var02.mat';  % Output filename
...
SC0tr =    ([   1      sqrt(2)       1     1*ones(1,7)    sqrt(2)*ones(1,7)  1*ones(1,7)   ]).^2/2;  % Initial conditions Q
...
for jm = 1:Ndraws  % MCMC draws
    ...
    theta_new = theta_old + randn(size(theta_old))*std_theta/5;  % Perturb theta
