% This file replicates the plots for the "Baseline" model with alternative degrees of freedom. 
% See figures A8-A11.
...
addpath('Routines')
load('../results/OutputModel1_df50.mat')
...
%% Figure A8: Trends in Global and U.S. Real Rates, Baseline Model with 50 
% Degrees of freedom
...
printpdf(gcf, [appenpath 'figa8-Model1_df50_Rshortbar-us.pdf'])




%% Figure A9a: Trends and Observables for Short-Term Real Rates, Baseline 
% Model with 50 Degrees of Freedom
...
printpdf(gcf, [appenpath 'figa9a-Model1_df50_Rshortbar-obs.pdf'])


%% Figure A9b: Trends and Observables for Short-Term Real Rates, Baseline 
% Model with 50 Degrees of Freedom
...
legend boxoff;
box on;
printpdf(gcf, [appenpath 'figa9b-Model1_df50_Rshortbar-countries.pdf'])


%% Figure A10a: Trends and Observables for Inflation, Baseline Model 
%  Estimated with 50 Degrees of freedom
...
printpdf(gcf, [appenpath 'figa10a-Model1_df50_Pibar-obs.pdf'])

%% Figure A10b: Trends and Observables for Inflation, Baseline Model 
%  Estimated with 50 Degrees of freedom
...
printpdf(gcf, [appenpath 'figa10b-Model1_df50_Pibar-countries.pdf'])

%% A11a: Trends and Observables for Term Spreads, Baseline Model with 50 Degrees of Freedom
...
printpdf(gcf, [appenpath 'figa11a-Model1_df50_Tsbar.pdf'])


%% A11b: Trends and Observables for Term Spreads, Baseline Model with 50 Degrees of Freedom
...
printpdf(gcf, [appenpath 'figa11b-Model1_df50_Tsbar-countries.pdf'])
