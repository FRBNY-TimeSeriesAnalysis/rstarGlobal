function contributionPlot_nomrate(Year, Rshort_X_50, Rshort_bar_X, Rshort_bar_X_idio_50, ...
    ql_Pi_bar_us, qPi_bar_us_idio, colorScheme, title_label, legend_label, outfile)

% Add global and idiosyncratic inflation terms.

Area                 = [Rshort_X_50, Rshort_bar_X_idio_50, ql_Pi_bar_us qPi_bar_us_idio];
posArea              = Area;
negArea              = Area;
posArea(posArea < 0) = 0;
negArea(negArea > 0) = 0;
...
p1 = plot(Year, Rshort_X_50 + Rshort_bar_X_idio_50 + ql_Pi_bar_us + qPi_bar_us_idio, 'Color', 'k', 'LineWidth', 2);
