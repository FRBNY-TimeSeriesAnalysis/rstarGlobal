...
Rshort_bar_de_idio = squeeze(CommonTrends(:, 8,:));
Rshort_bar_uk_idio = squeeze(CommonTrends(:, 9,:));
Rshort_bar_fr_idio = squeeze(CommonTrends(:,10,:));
Rshort_bar_ca_idio = squeeze(CommonTrends(:,11,:));
Rshort_bar_it_idio = squeeze(CommonTrends(:,12,:));
Rshort_bar_jp_idio = squeeze(CommonTrends(:,13,:));

Pi_bar_us_idio = squeeze(CommonTrends(:,14,:));
Pi_bar_de_idio = squeeze(CommonTrends(:,15,:));
Pi_bar_uk_idio = squeeze(CommonTrends(:,16,:));
Pi_bar_fr_idio = squeeze(CommonTrends(:,17,:));
Pi_bar_ca_idio = squeeze(CommonTrends(:,18,:));
Pi_bar_it_idio = squeeze(CommonTrends(:,19,:));
Pi_bar_jp_idio = squeeze(CommonTrends(:,20,:));

Ts_bar_us_idio = squeeze(CommonTrends(:,21,:));
Ts_bar_de_idio = squeeze(CommonTrends(:,22,:));
Ts_bar_uk_idio = squeeze(CommonTrends(:,23,:));
Ts_bar_fr_idio = squeeze(CommonTrends(:,24,:));
Ts_bar_ca_idio = squeeze(CommonTrends(:,25,:));
Ts_bar_it_idio = squeeze(CommonTrends(:,26,:));
Ts_bar_jp_idio = squeeze(CommonTrends(:,27,:));
...
qBeta_bar       = sBeta_bar(:,ceil(Quant*M));
qGamma_bar      = sGamma_bar(:,ceil(Quant*M));
